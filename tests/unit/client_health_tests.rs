//! Tests for ChippClient health check and ping methods.
...
#[tokio::test]
async fn test_is_healthy_returns_true_for_200_ok() {
    // ARRANGE
...
#[tokio::test]
async fn test_is_healthy_returns_false_for_500_error() {
    // ARRANGE
    let mut server = mockito::Server::new_async().await;
    let mock = server
        .mock("HEAD", "/chat/completions")
...
#[tokio::test]
async fn test_is_healthy_returns_false_for_404_error() {
    // ARRANGE
    let mut server = mockito::Server::new_async().await;
    let mock = server
        .mock("HEAD", "/chat/completions")
...
#[tokio::test]
async fn test_is_healthy_returns_err_for_network_failure() {
